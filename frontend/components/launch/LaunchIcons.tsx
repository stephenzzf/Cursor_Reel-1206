/**
 * Launch Icons - 启动页面图标组件
 */

import React from 'react';

export const AnimatedLogoIcon: React.FC<{ className?: string }> = ({ className }) => (
    <div className={`relative ${className}`}>
        <svg viewBox="0 0 100 100" className="w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <g className="origin-center">
                 <circle cx="50" cy="50" r="48" stroke="url(#logo-grad-ring)" strokeWidth="1.5" className="animate-spin" style={{animationDuration: '10s'}} />
                 <circle cx="50" cy="50" r="40" stroke="url(#logo-grad-ring)" strokeWidth="1" className="animate-spin" style={{animationDuration: '15s', animationDirection: 'reverse'}} opacity="0.7"/>
            </g>
